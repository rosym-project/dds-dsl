...
public class DDS_LeaseDuration_Constraints extends BaseConstraintsDescriptor {
  public DDS_LeaseDuration_Constraints() {
    super(CONCEPTS.DDS_LeaseDuration$vx);
  }
  ...
  public static class Value_Property extends BasePropertyConstraintsDescriptor {
    public Value_Property(ConstraintsDescriptor container) {
      super(PROPS.value$nA9S, container);
    }
    @Override
    public boolean hasOwnValidator() {
      return true;
    }
    private static final SNodePointer validatePropertyBreakingPoint = new SNodePointer("r:97064961-0fd3-418e-b398-23c3c6198617(DDS.constraints)", "7566676200133472436");
    @Override
  ...
  protected Map<SProperty, PropertyConstraintsDescriptor> getSpecifiedProperties() {
    ...
    properties.put(PROPS.value$nA9S, new Value_Property(this));
    return properties;
  }
